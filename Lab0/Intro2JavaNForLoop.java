...
public class Intro2JavaNForLoop {
     ...
     * multiplication table from an input number M,
     * it shows values of 1M until 12M in this form. Use tab(\t) to make a tab in
     * java.
     * X M
     * 1 M
     * 2 2M
    ...
    /*
     * Exercise 2 Complete the method deductK(int M, iny k) that generates a
     * sequence of positive number
     * M M-k M-2k M-3k ... .
     */
     ...
     * an upward right triangle made by * characters.
     ...
     * generates a downward right triangle made by * characters.
     * An example of output when w = 4 is as follows.
     ****
     ***
     **
     ...
     * upward isosceles made by * characters.
