...
public class HashTable {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		System.out.println(
				"Hashing data in A to Hashtable1 of size 13 using the division hash function and solve collision using linear probing");
		...
		System.out.println(
				"Hashing data in A to Hashtable2 of size 13 using the division hash function and open addressing collision resolution with quadratic probing");
		// Create HashTable2
		...
		System.out.println(
				"\nHashing data in B to Hashtable3 of size 17 using the folding hash function and open addressing collision resolution with linear probing");
		...
		System.out.println(
				"Hashing data in B to Hashtable4 of size 17 using Folding hash function and Open addressing collision resolution with Quadratic probing");
